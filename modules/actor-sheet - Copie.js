        ...
        let d = new Dialog({
            ...
            content: `<div class="conspiracyx-dialog-menu">
                            ...
                            <div class="conspiracyx-dialog-menu-text-box">
                                <div>
                                    <p>{{ localize "CONX.Apply modifiers" }}</p>
                                    
                                    <ul>
                                        <li>{{ localize "CONX.Simple Test" }}</li>
                                        <li>{{ localize "CONX.Difficult Test" }}</li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="table-center-align">
                                            <select id="skillSelect" name="skills">
                                                <option value="None">{{ localize "CONX.None" }}</option>
                                                ${skillOptions.join('')}
                                            </select>
                                        </td>
                                    </tr>
                ...
                two: {
                    ...
                    callback: html => {
                        ...
                        let chatContent = `<form>
                                                <h2>${attributeLabel} {{ localize "CONX.Roll" }} [${actorData[attributeLabel.toLowerCase()].value}]</h2>

                                                <table class="conspiracyx-chat-roll-table">
                                                    <thead>
                                                        <tr>
                                                            <th>{{ localize "CONX.Roll" }}</th>
                                                            <th>{{ localize "CONX.Modifier" }}</th>
                                                            <th>{{ localize "CONX.Result" }}</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr>
            ...
            buttons: {
                ...
                two: {
                    ...
                    callback: html => {
                        ...
                        let tags = [`<div>{{ localize "CONX.Damage Roll" }}</div>`]
                        ...
                        let chatContent = `<div>
                                                ...
                                                <table class="conspiracyx-chat-roll-table">
                                                    <thead>
                                                        <tr>
                                                            <th>{{ localize "CONX.Damage" }}</th>
                                                            <th>{{ localize "CONX.Detail" }}</th>
                                                        </tr>
                                                    </thead>
                                                    <tbody>
                                                        <tr>
